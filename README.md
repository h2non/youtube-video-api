...
It was especially designed to provide a reliable server-to-server automation solution, with additional support for transparent Google OAuth2 token negotiation and fetching using [PhantomJS](http://phantomjs.org).
