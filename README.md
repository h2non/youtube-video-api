...
Simple **node.js/io.js programmatic interface to** easily **upload and delete videos** from **YouTube** using OAuth2 and the API v3

**Note**: this is still a beta implementation, don't use it for serious stuff yet
